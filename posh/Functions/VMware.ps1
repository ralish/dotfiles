...
Function Global:Optimize-VMwareVirtualMachine {
    ...
    try {
        ...
        foreach ($SubDir in $SubDirs) {
            ...
            Get-ChildItem -LiteralPath $SubDir.FullName -Directory | Where-Object Name -EQ 'caches' | Remove-Item -Recurse -Force
            Get-ChildItem -LiteralPath $SubDir.FullName -File | Where-Object Extension -Match '\.(log|scoreboard)$' | Remove-Item -Force
        }
    } finally {
