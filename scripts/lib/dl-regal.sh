...
# Application name
readonly APP_NAME="regal"
# Local installation path
readonly APP_DST="$HOME/bin/regal"
# Latest release information
readonly APP_LATEST_RELEASE='https://api.github.com/repos/StyraInc/regal/releases/latest'

# DESC: Download latest Regal
# ARGS: None
# OUTS: None
# RETS: None
function dl_regal() {
