...
# Application name
readonly APP_NAME="opa"
# Local installation path
readonly APP_DST="$HOME/bin/opa"
# Latest release information
readonly APP_LATEST_RELEASE='https://api.github.com/repos/open-policy-agent/opa/releases/latest'

# DESC: Download latest OPA
# ARGS: None
# OUTS: None
# RETS: None
function dl_opa() {
    ...
    local latest_url
    latest_url="$(echo "$metadata" | jq -Mr ".assets[] | select(.name | endswith(\"${latest_contains}_static\")) | .browser_download_url")"
